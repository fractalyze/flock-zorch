...
def main():
    ...
    def prove_once():
        ...
        transcript = flock_transcript(b"flock-keccak3-lig-v0")
        ...
        lp, transcript = lincheck.prove(g["zlc"], None, None, x_ab, m, k_log, k_skip, transcript=transcript, capture=True, circuit=circ)
        _r, _zp, lcc, _zv = lp
