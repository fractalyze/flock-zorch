...
def load():
    rd = R((ART / "keccak_ligerito_golden.bin").read_bytes())
...
def run():
    ...
    transcript = flock_transcript(b"flock-keccak-lig-v0")
...
def main() -> int:
    ...
    print(f"keccak LIGERITO full prove (R1csProofLigerito) vs flock prove_fast (m={m}): "
